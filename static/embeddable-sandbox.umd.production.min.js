!(function (e, t) {
  ...
  const e = (e = !1) =>
    ...
    t = 'SchemaError',
    n = 'ExplorerResponse',
    i = 'ExplorerSubscriptionResponse',
    o = 'ExplorerSetSocketStatus',
    r = (e) => `apollo-embed-${e}`;
  function s(e, t, n, i) {
  ...
  const {
    asciiLowercase: u,
    solelyContainsHTTPTokenCodePoints: p,
    soleyContainsHTTPQuotedStringTokenCodePoints: d,
  } = l;
  var f = class {
    constructor(e) {
      this._map = e;
    ...
    has(e) {
      return (e = u(String(e))), this._map.has(e);
    }
    set(e, t) {
      if (((e = u(String(e))), (t = String(t)), !p(e)))
        throw new Error(
    ...
    delete(e) {
      return (e = u(String(e))), this._map.delete(e);
    }
    forEach(e, t) {
  ...
  const {
      removeLeadingAndTrailingHTTPWhitespace: h,
      removeTrailingHTTPWhitespace: m,
      isHTTPWhitespaceChar: y,
      solelyContainsHTTPTokenCodePoints: v,
      soleyContainsHTTPQuotedStringTokenCodePoints: b,
      asciiLowercase: g,
      collectAnHTTPQuotedString: E,
    } = l,
    { solelyContainsHTTPTokenCodePoints: w } = l,
    T = f,
    { asciiLowercase: I, solelyContainsHTTPTokenCodePoints: _ } = l;
  function S(e, t) {
  ...
  C() && !N('observable') && (Symbol.observable = Symbol('observable'));
  var A = k('iterator'),
    P = k('observable'),
    j = k('species');
  function R(e, t) {
  ...
  function M(e) {
    var t = e.constructor;
    return (
      void 0 !== t && null === (t = t[j]) && (t = void 0), void 0 !== t ? t : W
    );
  }
  function F(e) {
  ...
  var G = (function () {
      ...
      return (
        (e.prototype.unsubscribe = function () {
          'closed' !== this._state && (q(this), U(this));
        }),
        x(e, [
          {
            key: 'closed',
      ...
      return (
        ...
        (t.flatMap = function (e) {
          ...
          return new n(function (i) {
            ...
            function s() {
              r.closed && 0 === o.length && i.complete();
            }
            return function () {
        ...
        (e.from = function (t) {
          ...
          if (i) {
            ...
            return F(o) && o.constructor === n
              ? o
              : new n(function (e) {
                  return o.subscribe(e);
                });
          }
          if (N('iterator') && (i = R(t, A)))
  ...
  function B(e) {
    const t = null != e ? e : {};
    return (
      Object.keys(t).every((e) => 'content-type' !== e.toLowerCase()) &&
        (t['content-type'] = 'application/json'),
      t
    );
  }
  function H({ message: e, embeddedIFrameElement: t, embedUrl: n }) {
    var i;
    null === (i = null == t ? void 0 : t.contentWindow) ||
      void 0 === i ||
      i.postMessage(e, n);
  }
  function J({
    ...
    variables: p,
    fileVariables: d,
    embeddedIFrameElement: f,
    embedUrl: S,
    isMultipartSubscription: O,
    multipartSubscriptionClient: x,
  }) {
    return s(this, void 0, void 0, function* () {
      const C = { query: l, variables: p, operationName: u };
      let N;
      if (d && d.length > 0) {
        const n = yield (({ fileVariables: e, requestBody: t }) =>
          s(void 0, void 0, void 0, function* () {
            const n = e.map((e) =>
                Object.assign(Object.assign({}, e), {
                  files: e.files.map(
                    ({ arrayBuffer: e, fileName: t }) =>
                      new File([new Blob([e])], t)
                  ),
                })
              ),
              i = {};
            ...
            const r = [];
            let s = t.variables;
            n.forEach(({ files: e, variableKey: t, isMultiFile: a }, c) => {
              (null == e ? void 0 : e.length) &&
                ((s = Object.assign(Object.assign({}, s), {
                  [t]: a ? new Array(e.length).fill(null) : null,
                })),
                Array.from(e).forEach((e) => {
                  (i[o] = [
                    `${n.length > 1 ? `${c}.` : ''}variables.${t}${a ? `.${o}` : ''}`,
                  ]),
                    r.push([o.toString(), e, e.name]),
                    o++;
                }));
            });
            ...
            return (
              ...
              a.append('map', JSON.stringify(i)),
              r.forEach((e) => {
                a.append(e[0], e[1], e[2]);
              }),
              a
            );
          }))({ fileVariables: d, requestBody: C });
        N = t(
          e,
          Object.assign(
            { method: 'POST', headers: null != r ? r : {}, body: n },
        ...
        N = t(
          e,
          Object.assign(
            { method: 'POST', headers: B(r), body: JSON.stringify(C) },
            a ? { credentials: 'include' } : { credentials: 'omit' }
          )
        );
      N.then((e) =>
        s(this, void 0, void 0, function* () {
              ...
              new (class {
                constructor(e) {
                  const t = ((e) => {
                    ...
                    if (0 === n.length || !v(n)) return null;
                    if (t >= e.length) return null;
                    ++t;
                    let i = '';
                    for (; t < e.length && ';' !== e[t]; ) (i += e[t]), ++t;
                    if (((i = m(i)), 0 === i.length || !v(i))) return null;
                    const o = {
                      type: g(n),
                      subtype: g(i),
                      parameters: new Map(),
                    ...
                    for (; t < e.length; ) {
                      ...
                      let i = null;
                      if ('"' === e[t])
                        for ([i, t] = E(e, t); t < e.length && ';' !== e[t]; )
                          ++t;
                      else {
                        for (i = ''; t < e.length && ';' !== e[t]; )
                          (i += e[t]), ++t;
                        if (((i = m(i)), '' === i)) continue;
                      }
                      n.length > 0 &&
                  ...
                  (this._type = t.type),
                    ...
                    (this._parameters = new T(t.parameters));
                }
                static parse(e) {
                  try {
                    return new this(e);
                ...
                set subtype(e) {
                  if (0 === (e = I(String(e))).length)
                    throw new Error(
                      'Invalid subtype: must be a non-empty string'
                    );
                  if (!_(e))
                    throw new Error(
          ...
          if (a && 'multipart' === a.type && 'mixed' === a.subtype) {
            null == x || x.emit('connected');
            const { observable: t, closeReadableStream: s } = (function (e, t) {
              if (null === e.body) throw new Error('Missing body');
              if ('function' != typeof e.body.tee)
                throw new Error(
                  'Streaming bodies not supported by provided fetch implementation'
                );
              const n = new TextDecoder('utf-8');
              let i = '';
              const o = `--${t.parameters.get('boundary') || '-'}`,
                r = e.body.getReader();
              return {
                closeReadableStream: () => r.cancel(),
                observable: new W((e) => {
                  !(function t() {
                    r.read()
                      .then((r) => {
                        ...
                        const l = n.decode(r.value);
                        i += l;
                        let u = i.indexOf(o);
                        for (; u > -1; ) {
                          const t = i.slice(0, u);
                          if (((i = i.slice(u + o.length)), t.trim())) {
                            const n = '\r\n\r\n';
                            let i;
                            if (t.lastIndexOf(n) !== t.indexOf(n)) {
                              const e = t.indexOf(n) + n.length;
                              i = t.substring(e).indexOf(n) + e;
                            } else i = t.indexOf(n);
                            ...
                            if (
                              -1 ===
                              (null === (a = o['content-type']) || void 0 === a
                                ? void 0
                                : a.toLowerCase().indexOf('application/json'))
                            )
                      ...
                      .catch((t) => {
                        ...
                        'AbortError' !== t.name &&
                          (t.result &&
                            ...
                            (null === (n = e.next) ||
                              void 0 === n ||
                              n.call(e, { data: t.result, size: Infinity })),
                          null === (i = e.error) ||
                            void 0 === i ||
                            i.call(e, t));
                      });
            ...
            const u = t.subscribe({
              next(t) {
                'payload' in t.data
                  ? ('shouldTerminate' in t &&
                      t.shouldTerminate &&
                      (u.unsubscribe(),
                      s(),
                      H({
                        message: { name: o, status: 'disconnected' },
                        embeddedIFrameElement: f,
                        embedUrl: S,
                      })),
                    H({
                  ...
                  : H({
                      message: {
                        ...
                        operationId: c,
                        response: {
                          incremental: t.data.incremental,
                          data: t.data.data,
              ...
              error(e) {
                const t =
                  ...
                  'string' == typeof e.message
                    ? Object.assign(
                        { message: e.message },
                        'stack' in e && 'string' == typeof e.stack
                          ? { stack: e.stack }
                          : {}
                      )
                    : void 0;
              ...
              complete() {
                H({
                  message: {
                    ...
                    operationId: c,
                    response: Object.assign(
                      { data: null, status: e.status, headers: l ? r : void 0 },
                      O ? {} : { hasNext: !1 }
                    ),
                  },
                  embeddedIFrameElement: f,
            ...
            x &&
              (x.stopListeningCallback = () => {
                s(), u.unsubscribe();
              });
          } else {
            const t = yield e.json();
            null == x || x.emit('error'),
              null == x || x.emit('disconnected'),
              H({
                message: {
                  name: O ? i : n,
                  operationId: c,
                  response: Object.assign(Object.assign({}, t), {
                    status: e.status,
                    headers: r,
                    hasNext: !1,
                  }),
        ...
        null == x || x.emit('error', e), null == x || x.emit('disconnected');
        const t =
          e &&
          'object' == typeof e &&
          'message' in e &&
  ...
  C() &&
    Object.defineProperty(W, Symbol('extensions'), {
      value: { symbol: P, hostReportError: L },
      configurable: !0,
    });
  var z = { exports: {} };
  !(function (e) {
      ...
      (a.prototype.emit = function (e, t, i, o, r, s) {
        ...
        if (u.fn) {
          switch ((u.once && this.removeListener(e, u.fn, void 0, !0), p)) {
            ...
            case 6:
              return u.fn.call(u.context, t, i, o, r, s), !0;
          }
          ...
          for (l = 0; l < f; l++)
            switch (
              ...
              case 3:
                ...
                break;
              case 4:
                u[l].fn.call(u[l].context, t, i, o);
                break;
              default:
                if (!c)
                  for (d = 1, c = new Array(p - 1); d < p; d++)
                    c[d - 1] = arguments[d];
  ...
  function ne(e) {
    if (!ee(e))
      throw new Error(`Message is expected to be an object, but got ${Z(e)}`);
    if (!e.type) throw new Error("Message is missing the 'type' property");
    if ('string' != typeof e.type)
      throw new Error(
        `Message is expects the 'type' property to be a string, but got ${Z(e.type)}`
      );
    switch (e.type) {
      ...
      case Y.Subscribe:
        if ('string' != typeof e.id)
          throw new Error(
            `"${e.type}" message expects the 'id' property to be a string, but got ${Z(e.id)}`
          );
        if (!e.id)
          throw new Error(
        ...
        if (!ee(e.payload))
          throw new Error(
            `"${e.type}" message expects the 'payload' property to be an object, but got ${Z(e.payload)}`
          );
        if ('string' != typeof e.payload.query)
          throw new Error(
            `"${e.type}" message payload expects the 'query' property to be a string, but got ${Z(e.payload.query)}`
          );
        if (null != e.payload.variables && !ee(e.payload.variables))
          throw new Error(
            `"${e.type}" message payload expects the 'variables' property to be a an object or nullish or missing, but got ${Z(e.payload.variables)}`
          );
        if (
          null != e.payload.operationName &&
          'string' !== Z(e.payload.operationName)
        )
          throw new Error(
            `"${e.type}" message payload expects the 'operationName' property to be a string or nullish or missing, but got ${Z(e.payload.operationName)}`
          );
        if (null != e.payload.extensions && !ee(e.payload.extensions))
          throw new Error(
            `"${e.type}" message payload expects the 'extensions' property to be a an object or nullish or missing, but got ${Z(e.payload.extensions)}`
          );
        break;
      case Y.Next:
        if ('string' != typeof e.id)
  ...
  function ie(e, t) {
    return ne(e), JSON.stringify(e, t);
  }
  function oe(e) {
    return ee(e) && 'code' in e && 'reason' in e;
  }
  function re(e, t) {
  ...
  const se = {
    ...
    ae = new Set(Object.keys(se));
  function ce(e) {
    const t = null == e ? void 0 : e.kind;
    return 'string' == typeof t && ae.has(t);
  }
  var le, ue;
  function pe(e) {
    return 9 === e || 32 === e;
      ...
      case 'object':
        return (function (e, t) {
          ...
          if (
            ...
            const t = e.toJSON();
            if (t !== e) return 'string' == typeof t ? t : de(t, n);
            ...
            return (function (e, t) {
              ...
              const n = Math.min(10, e.length),
                i = e.length - n,
                o = [];
              for (let i = 0; i < n; ++i) o.push(de(e[i], t));
              return (
                1 === i
                  ? o.push('... 1 more item')
  ...
  const be = {
    ...
    Document: { leave: (e) => ge(e.definitions, '\n\n') },
    OperationDefinition: {
      leave(e) {
        const t = we('(', ge(e.variableDefinitions, ', '), ')'),
          n = ge([e.operation, ge([e.name, t]), ge(e.directives, ' ')], ' ');
    ...
    FragmentSpread: {
      leave: ({ name: e, directives: t }) => '...' + e + we(' ', ge(t, ' ')),
    },
    InlineFragment: {
    ...
    FragmentDefinition: {
      leave: ({
        ...
        `fragment ${e}${we('(', ge(n, ', '), ')')} on ${t} ${we('', ge(i, ' '), ' ')}` +
        o,
    },
          ...
          ? (function (e, t) {
              const n = e.replace(/"""/g, '\\"""'),
                ...
                r =
                  ...
                  i
                    .slice(1)
                    .every((e) => 0 === e.length || pe(e.charCodeAt(0))),
                s = n.endsWith('\\"""'),
                a = e.endsWith('"') && !s,
                c = e.endsWith('\\'),
                l = a || c,
                u = !o || e.length > 70 || l || r || s;
              let p = '';
              const d = o && pe(e.charCodeAt(0));
              return (
                ((u && !d) || r) && (p += '\n'),
                (p += n),
                (u || l) && (p += '\n'),
    ...
    ListValue: { leave: ({ values: e }) => '[' + ge(e, ', ') + ']' },
    ObjectValue: { leave: ({ fields: e }) => '{' + ge(e, ', ') + '}' },
    ObjectField: { leave: ({ name: e, value: t }) => e + ': ' + t },
    Directive: {
      leave: ({ name: e, arguments: t }) => '@' + e + we('(', ge(t, ', '), ')'),
    },
    ...
    ObjectTypeDefinition: {
      leave: ({
        ...
        we('', e, '\n') +
        ge(
          ['type', t, we('implements ', ge(n, ' & ')), ge(i, ' '), Ee(o)],
          ' '
        ),
    },
    FieldDefinition: {
    ...
    InterfaceTypeDefinition: {
      leave: ({
        ...
        we('', e, '\n') +
        ge(
          ['interface', t, we('implements ', ge(n, ' & ')), ge(i, ' '), Ee(o)],
          ' '
        ),
    },
    UnionTypeDefinition: {
    ...
    SchemaExtension: {
      leave: ({ directives: e, operationTypes: t }) =>
        ge(['extend schema', ge(e, ' '), Ee(t)], ' '),
    },
    ScalarTypeExtension: {
      leave: ({ name: e, directives: t }) =>
        ge(['extend scalar', e, ge(t, ' ')], ' '),
    },
    ObjectTypeExtension: {
    ...
    UnionTypeExtension: {
      leave: ({ name: e, directives: t, types: n }) =>
        ge(['extend union', e, ge(t, ' '), we('= ', ge(n, ' | '))], ' '),
    },
    EnumTypeExtension: {
      leave: ({ name: e, directives: t, values: n }) =>
        ge(['extend enum', e, ge(t, ' '), Ee(n)], ' '),
    },
    InputObjectTypeExtension: {
      leave: ({ name: e, directives: t, fields: n }) =>
        ge(['extend input', e, ge(t, ' '), Ee(n)], ' '),
    },
  };
  function ge(e, t = '') {
    var n;
  ...
  var _e = {
      __proto__: null,
      print: function (e) {
        return (function (e, t, n = se) {
          const i = new Map();
          for (const e of Object.values(ue)) i.set(e, ve(t, e));
          let o,
            r,
            s,
            a = Array.isArray(e),
          ...
          do {
            ...
            if (e) {
              ...
              if (((r = a ? l : c[l]), (p = s[r]), null == p)) continue;
              d.push(r);
            }
            let g;
            if (!Array.isArray(p)) {
              var h, m;
              ce(p) || re(!1, `Invalid AST Node: ${((v = p), de(v, []))}.`);
              const n = e
                ? null === (h = i.get(p.kind)) || void 0 === h
                  ? void 0
                  : h.leave
                : null === (m = i.get(p.kind)) || void 0 === m
                  ? void 0
                  : m.enter;
              if (
                ((g = null == n ? void 0 : n.call(t, p, r, s, d, f)), g === ye)
              )
                break;
              if (!1 === g) {
                if (!e) {
            ...
            var y;
            void 0 === g && b && u.push([r, p]),
              e
                ? d.pop()
                : ((o = { inArray: a, index: l, keys: c, edits: u, prev: o }),
                  (a = Array.isArray(p)),
                  (c = a
                    ? p
                    : null !== (y = n[p.kind]) && void 0 !== y
                      ? y
                      : []),
                  (l = -1),
                  (u = []),
    ...
    Se = {
      ...
      getOperationAST: function (e, t) {
        ...
        for (const o of e.definitions) {
          var i;
          if (o.kind === ue.OPERATION_DEFINITION)
            if (null == t) {
              if (n) return null;
              n = o;
            } else if (
              (null === (i = o.name) || void 0 === i ? void 0 : i.value) === t
            )
              return o;
        }
        return n;
  ...
  Object.defineProperty(Me, '__esModule', { value: !0 }),
    (Me.GRAPHQL_SUBSCRIPTIONS = Me.GRAPHQL_WS = void 0),
    (Me.GRAPHQL_WS = 'graphql-ws'),
    (Me.GRAPHQL_SUBSCRIPTIONS = 'graphql-subscriptions');
  var Fe = {};
  Object.defineProperty(Fe, '__esModule', { value: !0 }),
    (Fe.WS_TIMEOUT = Fe.MIN_WS_TIMEOUT = void 0),
    (Fe.MIN_WS_TIMEOUT = 1e3),
    (Fe.WS_TIMEOUT = 3e4);
  var Le = {};
  ...
  var Ge = (Oe.SubscriptionClient = void 0),
    Qe = void 0 !== a ? a : 'undefined' != typeof window ? window : {},
    We = Qe.WebSocket || Qe.MozWebSocket,
    Be = xe,
    He = Ne.exports,
    Je = ke,
    ze = Ae,
    ...
    nt = (function () {
      function e(e, t, n, i) {
        var o = t || {},
          ...
          c = void 0 === a ? {} : a,
          l = o.minTimeout,
          u = void 0 === l ? et.MIN_WS_TIMEOUT : l,
          p = o.timeout,
          d = void 0 === p ? et.WS_TIMEOUT : p,
          f = o.reconnect,
          h = void 0 !== f && f,
          m = o.reconnectionAttempts,
          y = void 0 === m ? Infinity : m,
          v = o.lazy,
          b = void 0 !== v && v,
          g = o.inactivityTimeout,
          E = void 0 === g ? 0 : g,
          w = o.wsOptionArguments,
          T = void 0 === w ? [] : w;
        if (((this.wsImpl = n || We), !this.wsImpl))
          throw new Error(
            'Unable to find native implementation, or alternative implementation for WebSocket!'
          );
        (this.wsProtocols = i || Ze.GRAPHQL_WS),
          ...
          (this.lazy = !!b),
          (this.inactivityTimeout = E),
          (this.closedByUser = !1),
          (this.backoff = new Be({ jitter: 0.5 })),
          (this.eventEmitter = new He.EventEmitter()),
          (this.middlewares = []),
          (this.client = null),
          (this.maxConnectTimeGenerator = this.createMaxConnectTimeGenerator()),
          (this.connectionParams = this.getConnectionParams(c)),
          (this.wsOptionArguments = T),
      ...
      return (
          ...
          void 0 === e && (e = !0),
            ...
            null !== this.client &&
              ...
              e &&
                ...
                this.sendMessage(
                  void 0,
                  tt.default.GQL_CONNECTION_TERMINATE,
                  null
                )),
              this.client.close(),
        ...
        (e.prototype.applyMiddlewares = function (e) {
          ...
          return new Promise(function (n, i) {
            var o, r, s;
            (o = Ve([], t.middlewares, !0)),
              (r = t),
              (s = function (t) {
                if (t) i(t);
                else if (o.length > 0) {
                  var a = o.shift();
                  a && a.applyMiddleware.apply(r, [e, s]);
                } else n(e);
              })();
          });
        }),
              ...
              .then(function (e) {
                n.checkOperationOptions(e, t),
                  n.operations[i] &&
                    ...
                    n.sendMessage(i, tt.default.GQL_START, e));
              })
              .catch(function (e) {
        ...
        (e.prototype.checkOperationOptions = function (e, t) {
          ...
          if (
            (!(0, Je.default)(n) && !(0, Ye.getOperationAST)(n, o)) ||
            (o && !(0, Je.default)(o)) ||
            (i && !(0, ze.default)(i))
          )
            throw new Error(
        ...
        (e.prototype.connect = function () {
          ...
          (this.client = new ((e = this.wsImpl).bind.apply(
            e,
            Ve([void 0, this.url, this.wsProtocols], this.wsOptionArguments, !1)
          ))()),
              ...
              return qe(t, void 0, void 0, function () {
                ...
                return $e(this, function (n) {
                  switch (n.label) {
                    ...
                    case 1:
                      return (
                        n.trys.push([1, 3, , 4]), [4, this.connectionParams()]
                      );
                    case 2:
                      return (
                        (e = n.sent()),
                        this.sendMessage(
                          void 0,
                          tt.default.GQL_CONNECTION_INIT,
                          e
                        ),
                    ...
                    case 3:
                      return (
                        ...
                        this.sendMessage(
                          void 0,
                          tt.default.GQL_CONNECTION_ERROR,
                          t
                        ),
                        this.flushUnsentMessagesQueue(),
                        [3, 4]
        ...
        (e.prototype.processReceivedData = function (e) {
          ...
          if (
            -1 ===
              [
                tt.default.GQL_DATA,
                tt.default.GQL_COMPLETE,
                tt.default.GQL_ERROR,
              ].indexOf(t.type) ||
            this.operations[n]
          )
            switch (t.type) {
              case tt.default.GQL_CONNECTION_ERROR:
                this.connectionCallback && this.connectionCallback(t.payload);
                break;
              case tt.default.GQL_CONNECTION_ACK:
                this.eventEmitter.emit(
                ...
                break;
              case tt.default.GQL_COMPLETE:
                var i = this.operations[n].handler;
                delete this.operations[n], i.call(this, null, null);
                break;
              case tt.default.GQL_ERROR:
                this.operations[n].handler(this.formatErrors(t.payload), null),
                  delete this.operations[n];
                break;
              case tt.default.GQL_DATA:
                ...
                break;
              case tt.default.GQL_CONNECTION_KEEP_ALIVE:
                var r = void 0 === this.wasKeepAliveReceived;
        ...
        (e.prototype.unsubscribe = function (e) {
          this.operations[e] &&
            ...
            this.sendMessage(e, tt.default.GQL_STOP, void 0));
        }),
        e
      );
    })();
  function it(e) {
    throw new Error(`Didn't expect to get here ${e}`);
  }
  Ge = Oe.SubscriptionClient = nt;
  class ot {
    constructor(e, t, n) {
    ...
    get graphWsClient() {
      var e, t;
      const n =
        null !== (e = this._graphWsClient) && void 0 !== e
          ? e
          : (function (e) {
              const {
                url: t,
              ...
              if (h) {
                ...
                'undefined' != typeof WebSocket
                  ? (b = WebSocket)
                  : 'undefined' != typeof global
                    ? (b = global.WebSocket || global.MozWebSocket)
                    : 'undefined' != typeof window &&
              ...
              const E = b,
                w = (() => {
                  const e = (() => {
                    ...
                    t = {
                      connecting: (null == f ? void 0 : f.connecting)
                        ? [f.connecting]
                        : [],
                      opened: (null == f ? void 0 : f.opened) ? [f.opened] : [],
                      connected: (null == f ? void 0 : f.connected)
                        ? [f.connected]
                        : [],
                      ping: (null == f ? void 0 : f.ping) ? [f.ping] : [],
                      pong: (null == f ? void 0 : f.pong) ? [f.pong] : [],
                      message: (null == f ? void 0 : f.message)
                        ? [e.emit, f.message]
                        : [e.emit],
                      closed: (null == f ? void 0 : f.closed) ? [f.closed] : [],
                      error: (null == f ? void 0 : f.error) ? [f.error] : [],
                    };
                  return {
                    onMessage: e.on,
                    on(e, n) {
              ...
              async function C() {
                      ...
                      (async () => {
                        if (S) {
                          if ((await u(O), !_))
                            return (
                              (I = void 0),
                              i({ code: 1e3, reason: 'All Subscriptions Gone' })
                            );
                          O++;
                        }
                        w.emit('connecting');
                        ...
                        T((e) => {
                          ...
                          (o.onerror = (e) => w.emit('error', e)),
                          (o.onclose = (e) => w.emit('closed', e)),
                          (o.onopen = async () => {
                            try {
                              w.emit('opened', o);
                              const e = 'function' == typeof n ? await n() : n;
                              if (o.readyState !== E.OPEN) return;
                              o.send(
                                ie(
                                  e
                                    ? { type: Y.ConnectionInit, payload: e }
                                ...
                                isFinite(c) &&
                                  ...
                                  (r = setTimeout(() => {
                                    o.close(
                                      K.ConnectionAcknowledgementTimeout,
                          ...
                          try {
                            const n = (function (e, t) {
                              try {
                                ...
                                if ('string' != typeof e)
                                  throw new Error(
                                    'Only strings are parsable messages'
                                  );
                            ...
                            if (
                              (w.emit('message', n),
                              'ping' === n.type || 'pong' === n.type)
                            )
                              return (
                                w.emit(n.type, !0, n.payload),
                                void ('pong' === n.type
                                  ? p()
                                  : a ||
                                    (o.send(
                                      ie(
                                        n.payload
                                          ? { type: Y.Pong, payload: n.payload }
                                          : { type: Y.Pong }
                                      )
                                    ),
                                    w.emit('pong', !1, n.payload)))
                              );
                            if (d) return;
                            if (n.type !== Y.ConnectionAck)
                              throw new Error(
                                `First message cannot be of type ${n.type}`
                              );
                            clearTimeout(r),
                              (d = !0),
                              w.emit('connected', o, n.payload),
                              (S = !1),
                              (O = 0),
                ...
                e.readyState === E.CLOSING && (await i);
                let o = () => {};
              ...
              function N(e) {
                if (
                  oe(e) &&
                  ((![1e3, 1001, 1006, 1005, 1012, 1013, 1013].includes(
                    (t = e.code)
                  ) &&
                    t >= 1e3 &&
                    t <= 1999) ||
                ...
                var t;
                if (x) return !1;
                if (oe(e) && 1e3 === e.code) return _ > 0;
                if (!l || O >= l) throw e;
                if (!p(e)) throw e;
                if (null == d ? void 0 : d(e)) throw e;
                return (S = !0);
              }
              return (
                i ||
                      ...
                      (async () => {
                        for (_++; ; )
                          try {
                            ...
                            return (
                              s.send(
                                ie({ id: n, type: Y.Subscribe, payload: e }, y)
                              ),
                              (r = () => {
                                i ||
                                  s.readyState !== E.OPEN ||
                                  s.send(ie({ id: n, type: Y.Complete }, y)),
                                  _--,
                                  (i = !0),
                                  a();
                              }),
                              void (await c.finally(l))
                            );
                          } catch (e) {
                            if (!N(e)) return;
                          }
              ...
              lazy: !0,
              connectionParams:
                null !== (t = this.headers) && void 0 !== t ? t : {},
              keepAlive: 1e4,
            });
      return (this._graphWsClient = n), n;
    }
    get transportSubscriptionClient() {
      var e, t;
      const n =
        null !== (e = this._transportSubscriptionClient) && void 0 !== e
          ? e
          : new Ge(this.url, {
              reconnect: !0,
              lazy: !0,
      ...
      return (this._transportSubscriptionClient = n), n;
    }
    get multipartClient() {
      var e;
      const t =
        null !== (e = this._multipartClient) && void 0 !== e
          ? e
          : Object.assign(new X(), { stopListeningCallback: void 0 });
      return (this._multipartClient = t), t;
    }
    onConnected(e) {
      return 'http-multipart' === this.protocol
        ? (this.multipartClient.on('connected', e),
          () => this.multipartClient.off('connected', e))
        : 'graphql-ws' === this.protocol
          ? this.graphWsClient.on('connected', e)
          : 'subscriptions-transport-ws' === this.protocol
            ? this.transportSubscriptionClient.onConnected(e)
            : void it(this.protocol);
    }
    onConnecting(e) {
      if ('http-multipart' !== this.protocol)
        return 'graphql-ws' === this.protocol
          ? this.graphWsClient.on('connecting', e)
          : 'subscriptions-transport-ws' === this.protocol
            ? this.transportSubscriptionClient.onConnecting(e)
            : void it(this.protocol);
    }
    onError(e) {
      return 'http-multipart' === this.protocol
        ? (this.multipartClient.on('error', e),
          () => this.multipartClient.off('error', e))
        : 'graphql-ws' === this.protocol
          ? this.graphWsClient.on('error', (t) => e(t))
          : 'subscriptions-transport-ws' === this.protocol
            ? this.transportSubscriptionClient.onError((t) => e(t))
            : void it(this.protocol);
    }
    onReconnecting(e) {
      if ('http-multipart' !== this.protocol && 'graphql-ws' !== this.protocol)
        return 'subscriptions-transport-ws' === this.protocol
          ? this.transportSubscriptionClient.onReconnecting(e)
          : void it(this.protocol);
    }
    onReconnected(e) {
      if ('http-multipart' !== this.protocol && 'graphql-ws' !== this.protocol)
        return 'subscriptions-transport-ws' === this.protocol
          ? this.transportSubscriptionClient.onReconnected(e)
          : void it(this.protocol);
    }
    onDisconnected(e) {
      return 'http-multipart' === this.protocol
        ? (this.multipartClient.on('disconnected', e),
          () => this.multipartClient.off('disconnected', e))
        : 'graphql-ws' === this.protocol
          ? this.graphWsClient.on('closed', e)
          : 'subscriptions-transport-ws' === this.protocol
            ? this.transportSubscriptionClient.onDisconnected(e)
            : void it(this.protocol);
    }
    dispose() {
      var e, t;
      if ('http-multipart' !== this.protocol)
        return 'graphql-ws' === this.protocol
          ? this.graphWsClient.dispose()
          : 'subscriptions-transport-ws' === this.protocol
            ? this.transportSubscriptionClient.close()
            : void it(this.protocol);
      null === (t = (e = this.multipartClient).stopListeningCallback) ||
        void 0 === t ||
        t.call(e);
    }
    request(e) {
      return {
        subscribe: (t) =>
          s(this, void 0, void 0, function* () {
            var n, i, o, r;
            return (
              'http-multipart' === this.protocol &&
                e.httpMultipartParams &&
                (yield J({
                  operation: e.query,
                  operationName: e.operationName,
                  variables: e.variables,
                  headers: null !== (n = this.headers) && void 0 !== n ? n : {},
                  includeCookies:
                    null !==
                      (o =
                        null === (i = e.httpMultipartParams) || void 0 === i
                          ? void 0
                          : i.includeCookies) &&
                    void 0 !== o &&
                    o,
                  endpointUrl: this.url,
                  embeddedIFrameElement: e.embeddedIFrameElement,
                  embedUrl: e.embedUrl,
                  operationId: e.operationId,
                  handleRequest:
                    null === (r = e.httpMultipartParams) || void 0 === r
                      ? void 0
                      : r.handleRequest,
                  isMultipartSubscription: !0,
                  multipartSubscriptionClient: this.multipartClient,
                })),
              'graphql-ws' === this.protocol &&
                this.unsubscribeFunctions.push(
                  this.graphWsClient.subscribe(
                    e,
                    Object.assign(Object.assign({}, t), {
                      next: (e) => {
                        var n;
                        return null === (n = t.next) || void 0 === n
                          ? void 0
                          : n.call(t, e);
                      },
                      error: (e) => {
              ...
              'subscriptions-transport-ws' === this.protocol
                ? this.transportSubscriptionClient.request(e).subscribe(t)
                : void 0
            );
          }),
      };
      ...
      if (
        ('http-multipart' === this.protocol &&
          (null === (t = (e = this.multipartClient).stopListeningCallback) ||
            ...
            t.call(e)),
        'graphql-ws' === this.protocol &&
          (this.unsubscribeFunctions.forEach((e) => {
            e();
          }),
          (this.unsubscribeFunctions = [])),
        'subscriptions-transport-ws' === this.protocol)
  ...
  function rt({ error: e, embeddedIFrameElement: t, embedUrl: n }) {
    H({
      message: { name: 'ExplorerSetSocketError', error: e },
      embeddedIFrameElement: t,
      embedUrl: n,
    });
  }
  function st({ status: e, embeddedIFrameElement: t, embedUrl: n }) {
    H({
      message: { name: o, status: e },
      embeddedIFrameElement: t,
      embedUrl: n,
    });
  }
  ...
  return class {
    constructor(n) {
      ...
      (this.options = n),
        ...
        (this.handleRequest =
          null !== (o = this.options.handleRequest) && void 0 !== o
            ? o
            : (
                ({ legacyIncludeCookies: e }) =>
                (t, n) =>
                  fetch(
                    t,
                    Object.assign(
        ...
        (this.uniqueEmbedInstanceId = at++),
        (this.embeddedSandboxIFrameElement = this.injectEmbed()),
        (this.disposable = (function ({
          handleRequest: n,
          embeddedSandboxIFrameElement: o,
          __testLocal__: r,
        }) {
          const a = e(r),
            c = (e) => {
              (({ event: e, embeddedIFrameElement: t, embedUrl: n }) => {
                const { data: i } = e;
                if ('SetPartialAuthenticationTokenForParent' === i.name) {
                  const e = window.localStorage.getItem(
                      'apolloStudioEmbeddedExplorerEncodedApiKey'
                    ),
                    t = e ? JSON.parse(e) : {};
                  (t[i.localStorageKey] = i.partialToken),
                    window.localStorage.setItem(
                      'apolloStudioEmbeddedExplorerEncodedApiKey',
                      JSON.stringify(t)
                    );
                }
                if ('TriggerLogoutInParent' === i.name) {
                  const e = window.localStorage.getItem(
                      'apolloStudioEmbeddedExplorerEncodedApiKey'
                    ),
                    o = e ? JSON.parse(e) : {};
                  delete o[i.localStorageKey],
                    window.localStorage.setItem(
                      'apolloStudioEmbeddedExplorerEncodedApiKey',
                      JSON.stringify(o)
                    ),
                    H({
                      message: { name: 'ParentLogoutSuccess' },
                      embeddedIFrameElement: t,
                      embedUrl: n,
                    });
                }
                if (
                  'ExplorerListeningForPartialToken' === i.name &&
                  i.localStorageKey
                ) {
                  const e = window.localStorage.getItem(
                      'apolloStudioEmbeddedExplorerEncodedApiKey'
                  ...
                  o &&
                    ...
                    H({
                      message: {
                        ...
                        partialToken: o[i.localStorageKey],
                      },
                      embeddedIFrameElement: t,
                      embedUrl: n,
                    });
                }
              })({ event: e, embedUrl: a, embeddedIFrameElement: o });
              const r = 'object' == typeof e.data ? e.data : void 0;
              if (r && 'name' in r) {
                if (
                  ('ExplorerListeningForHandshake' === r.name &&
                    H({
                      message: {
                        name: 'HandshakeResponse',
                        parentHref: window.location.href,
                      },
                      embeddedIFrameElement: o,
                      embedUrl: a,
                    }),
                  'IntrospectionQueryWithHeaders' === r.name)
                ) {
                  const {
                    introspectionRequestBody: e,
                    introspectionRequestHeaders: i,
                    includeCookies: c,
                    sandboxEndpointUrl: l,
                    operationId: u,
                  } = r;
                  l &&
                    (function ({
                      ...
                      headers: n,
                      includeCookies: i,
                      introspectionRequestBody: o,
                      embeddedIFrameElement: r,
                      embedUrl: a,
                      handleRequest: c,
                      operationId: l,
                    }) {
                      s(this, void 0, void 0, function* () {
                        const { query: s, operationName: u } = JSON.parse(o);
                        return c(
                          e,
                          Object.assign(
                            {
                          ...
                          .catch((e) => {
                            H({
                              message: { name: t, error: e, operationId: l },
                              embeddedIFrameElement: r,
                              embedUrl: a,
                            });
                          });
                ...
                const e = 'ExplorerRequest' === r.name,
                  c = 'ExplorerSubscriptionRequest' === r.name;
                if ((e || c) && r.operation && r.operationId) {
                  const {
                    operation: t,
                    variables: s,
                    operationName: l,
                  ...
                  if (e) {
                    const { endpointUrl: e, includeCookies: i } = r;
                    if (!e)
                      throw new Error(
                    ...
                    J({
                      ...
                      variables: s,
                      fileVariables:
                        'fileVariables' in r ? r.fileVariables : void 0,
                      operationName: l,
                      embedUrl: a,
                      isMultipartSubscription: !1,
                    });
                  } else if (c) {
                    const { httpMultipartParams: e } = r;
                    !(function ({
                      operation: e,
                      operationName: t,
                      variables: n,
                      ...
                      subscriptionUrl: c,
                      protocol: l,
                      httpMultipartParams: u,
                    }) {
                      const p = new ot(c, null != o ? o : {}, l),
                        d = (e) => {
                          'ExplorerSubscriptionTermination' === e.data.name &&
                            (p.unsubscribeAll(),
                      ...
                      protocol: r.protocol,
                      httpMultipartParams: Object.assign(Object.assign({}, e), {
                        handleRequest: n,
                      }),
                    });
                  }
          ...
          return (
            ...
            { dispose: () => window.removeEventListener('message', c) }
          );
        })({
    ...
    dispose() {
      var e;
      null === (e = document.getElementById(r(this.uniqueEmbedInstanceId))) ||
        void 0 === e ||
        e.remove(),
    ...
    injectEmbed() {
      var t, n, i, o, s, a;
      let c;
      const { target: l, runTelemetry: u } = this.options,
        { includeCookies: p, sharedHeaders: d } =
        ...
        f = Object.assign(
            ...
            Object.assign(
              {
                ...
                sendOperationHeadersInIntrospection:
                  null ===
                    (t = this.options.sendOperationHeadersInIntrospection) ||
                  void 0 === t ||
                  t,
              },
              this.options.initialState &&
                ...
                ? {
                    defaultCollectionEntryId:
                      this.options.initialState.operationId,
            ...
            this.options.initialState && 'document' in this.options.initialState
              ? {
                  ...
                  defaultVariables: this.options.initialState.variables
                    ? encodeURIComponent(
                        JSON.stringify(
                          this.options.initialState.variables,
                          null,
                          2
                        )
                      )
          ...
          {
            sharedHeaders: d ? encodeURIComponent(JSON.stringify(d)) : void 0,
            defaultIncludeCookies: p,
            hideCookieToggle:
              null === (n = this.options.hideCookieToggle) || void 0 === n || n,
            parentSupportsSubscriptions: !0,
            version: '2.5.1',
            runTelemetry: void 0 === u || u,
            initialRequestQueryPlan:
              null !== (i = this.options.initialRequestQueryPlan) &&
              void 0 !== i &&
              i,
            shouldDefaultAutoupdateSchema:
              null ===
                (s =
                  null === (o = this.options.initialState) || void 0 === o
                    ? void 0
                    : o.pollForSchemaUpdates) ||
              void 0 === s ||
              s,
          ...
          ? null ===
              (a =
                null === document || void 0 === document
                  ? void 0
                  : document.querySelector) || void 0 === a
            ? void 0
            : a.call(document, l)
          : l;
      const m = document.createElement('iframe');
      return (
        (m.src = `${e(this.__testLocal__)}?${h}`),
        (m.id = r(this.uniqueEmbedInstanceId)),
        !1 !== this.options.allowDynamicStyles &&
          m.setAttribute('style', 'height: 100%; width: 100%; border: none;'),
        null == c || c.appendChild(m),
        fetch(`${window.location.origin}/favicon.ico`)
          .then((e) => {
            if (
              ...
              ['icon', 'apple-touch-icon'].forEach((e) => {
                var n = document.createElement('link');
                (n.rel = e),
                  (n.href = `https://embeddable-explorer.cdn.apollographql.com/_latest/public/assets/favicon${t ? '-dark' : ''}.png`),
    ...
    validateOptions() {
      ...
      if (
        (void 0 !== this.options.includeCookies &&
          console.warn(
        ...
        void 0 !== this.options.includeCookies &&
          (void 0 !== this.options.hideCookieToggle ||
            void 0 !==
              (null === (e = this.options.initialState) || void 0 === e
                ? void 0
                : e.includeCookies)))
      )
        throw new Error(
